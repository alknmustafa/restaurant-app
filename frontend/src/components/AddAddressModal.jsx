...
import { addAddress } from "../services/adressService";
...
export default function AddAddressModal({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const newAddress = await addAddress(token, formData);
                ...
                <div className="px-7 pb-7 pt-6 sm:px-9">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-1.5 text-sm text-gray-500">
                            Add a delivery address to make your next order
                            faster and easier.
                        </p>
                    </div>
